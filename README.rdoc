...
The key file and a self-signed certificate can be genterated automatically by running 
the <tt>generate.rb</tt> script. Since this certificate is only being used for local 
development, you can just accept the defaults for all the prompts.
