...
- HTTP Proxy
- Rack Handler
- Rack application Spawn
- Rack application Restart

== TODO

This is a work in progress, and Prax is missing a lot of features to be
on par with Pow!!. Moslty on the configuration side of you development
machine. Yet it's already capable to start the HTTP server, to spawn your
apps and proxy requests to it.

- xip.io compatibility
